@XmlSchema(namespace = "http://www.opengis.net/swe/2.0", elementFormDefault = XmlNsForm.QUALIFIED, xmlns = {
		...
		@XmlNs(prefix = "swe2", namespaceURI = "http://www.opengis.net/swe/2.0"),
